...
food_truck_4 = FoodTruck.create(name: 'Pig-N-Out BBQ', category: 'American style', menu: 'BBQ meats' , availability: true, city: 'Paris 20', price_per_day: 136.5, user: user_2)
...
food_truck_6 = FoodTruck.create(name: 'Acapulco spices', category: 'Mexican style', menu: 'Mexican ok meals ' , availability: true, city: 'Paris 20', price_per_day: 696.9, user: foody_joe)
